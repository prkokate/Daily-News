...
export default class News extends Component {
    ...
    async componentDidMount(){
      ...
      if(this.props.search===0){
        let url=`https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.categ}&apiKey=${process.env.REACT_APP_API_KEY}&page=${this.state.page}&pageSize=${this.props.PageSize}`;
